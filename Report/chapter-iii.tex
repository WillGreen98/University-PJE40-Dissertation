\chapter{Methodology and Project Management} \label{Methodology}
...
Within the Project-initiation Document, a project Gantt Chart is supplied, the timeline for this project can be seen below in the formally submitted Gantt Chart. However, it is subject to change and adaptions due to unforeseen circumstances, this can happen to any real-world project with a specified deadline.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/chapter-3/ProjectGanttChart.pdf}
    \caption[Project Gantt Chart]{A Gantt Chart supplied within my PID.
