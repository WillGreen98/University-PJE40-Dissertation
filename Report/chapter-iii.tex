\chapter{Methodology and Project Management} \label{chapter:methodologyprojectplanning}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/chapter-3/GitKrackenKANBANBoard.png}
