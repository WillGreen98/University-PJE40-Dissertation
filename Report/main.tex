...
\includegraphics[width=0.8\textwidth, center]{figures/UoP_Primary_Logo_Stacked_pms.eps}
\vspace{10mm}

\begin{center}
% Put the full title  on the front page
\huge\textbf{\textsf{Domain analysis of feature implementations between Classic and Deep NLP models.}}\\
\vspace{1mm}
